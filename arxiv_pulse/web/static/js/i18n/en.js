const i18nEn = {
    ...
    settings: {
        ...
        s2ApiKeyHint: 'Optional S2 key, apply at semanticscholar.org (free); raises rate limits and avoids 429',
        ...
        updateKey: 'Update',
        profilesTitle: 'Research Profiles',
        profilesHint: 'Describe your research field in natural language and AI builds a retrieval plan across arXiv / journals / Semantic Scholar.',
        profilesCreate: 'New Profile',
        profilesEdit: 'Edit Profile',
        profileName: 'Name',
        profileNamePh: 'e.g. AI Remote Sensing',
        profileDesc: 'Description',
        profileDescPh: 'e.g. AI+remote sensing, focused on methane inversion and detection, algorithms and models',
        profileGenerate: 'Generate Plan',
        profileGenerateHint: 'AI-generated, editable',
        profilePlan: 'Retrieval Plan',
        profileS2Ph: 'Semantic Scholar query',
        profileKeywords: 'Keywords (journal filter)',
        profileKeywordsPh: 'Type keyword and press Enter (journal filter terms)',
        profileJournals: 'Journals',
        profileJournalPickPh: 'Type journal name, ISSN or abbreviation',
        profileJournalSyncing: 'Syncing journal catalog',
        profileJournalNone: 'No journals selected',
    ...
    chat: {
        ...
        uploadPdfDone: 'PDF uploaded and cached - you can ask now',
